                ...
                <Row>
                    <Col id="leftSection" className={`${classes.leftSection} col-md-4 pt-5`}>
                        <div className={`${classes["right-side"]}`}>
                            <h6>SEARCH PLAYER FOR NEW MATCH <br /> <span style={{ "font-size": "11px" }}>(You can click on play to send request for play new match)</span></h6>
                        </div>
                        <div className={`${classes.searchbar} ${classes["searchbar-left"]} ${classes["left"]}`}>
                            ...
                            />
                            <a id="leftSearchbtn" className={classes["search-icon"]}><FaSearch /></a>

                        </div>
                        <div id="startPlayer">
                            <div style={{ position: "none" }} className={`card ${classes["sp-card-left"]} mt-3 p-2 rounded`}>
                                <div className="second d-flex flex-row">
                                    <div className="image mr-2"> <img id={classes.playerImg} src={profileImg} className="rounded-circle" width="60" /> </div>
                                    <div >
                                        <div className={classes.userName}> <span > User Name</span>
                                        </div>
                    ...
                    <Col id="middleSection" className="col-md-4">
                        ...
                        <div id="bannerHeading" className={classes["banner-heading"]}>
                            PLAY <br /><br /> <span style={{ "font-size": "15px" }}>with</span> <br /> FRIENDS
                            <br />
                        </div>
                        <br />
                        <br />

                        <div id="searchMiddlePlay" className={`${classes.searchbar} ${classes["searchbar-middle"]} ${classes.middle}`}>
                            <input
                    ...
                    <Col id="rightSection" className={`col-md-4 pt-5 ${classes.rightSection}`}>
                        <div className={classes["right-side"]}>
                            <h6>SEARCH PLAYER FOR PREVIOUS MATCH <br /> <span style={{ "font-size": "11px" }}>(You can click on resume to send request for continue match)</span></h6>
