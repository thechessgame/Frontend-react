...
const Profile = () => {
  return (
    <>
      <Container id="renderProfile" className="tab-pane fade show active d-flex justify-content-center">
        <div className={`${classes["emp-profile"]} ${classes["pb-0"]}`}>
          <form method="post">
            <Row>
              <Col md="4">
                <div className={classes["profile-img"]}>
                  <img id={classes.profileImg} className={classes["rounded-lg"]} src={profileImg} alt="profile" />
                </div>
              </Col>
              <Col md="6">
                <div className="Experience">
                  ...
                  <p className="normal-font">
                    Join us on ${new Date().toLocaleDateString("en-IN")},$
                    {new Date().toLocaleTimeString("en-IN", { hour: "2-digit", minute: "2-digit" })}{" "}
                  </p>
                  <p className="bold-font">
                    Winning/Playing : <span>4/5</span>
                  </p>
                  <p className="bold-font">
                ...
                <div className="modal-dialog modal-dialog-centered" role="document">
                  <div className="modal-content">
                    <input
                      ...
                      name="editImage"
                      type="file"
                      className="file mt-3 ml-3"
                      data-show-preview="false"
                    />
                    <br />
                    <div className="modal-footer">
                      <button id="saveImage" type="submit" data-dismiss="modal">
                        Save Image
                      </button>
                      <button id="deleteImg" type="submit" data-dismiss="modal">
                        Delete Image
                      </button>
                    </div>
                  </div>
                ...
                <Col md="4">
                  <label className="bold-font">
                    ...
                    <a
                      id="editName"
                      href="#"
                      className="btn rounded-pill btn-dark btn-sm edit"
                      data-toggle="modal"
